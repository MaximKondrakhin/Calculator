...
if __name__ == "__main__":
    ...
    button2 = Buton(gui, text=' 2 ', fg='black', bg='aqua', command=lambda: press(2), height=2, width=14)
    ...
    button5 = Button(gui, text=' 5 ', ='black', bg='aqua', command=lambda: press(5), height=2, width=14)
